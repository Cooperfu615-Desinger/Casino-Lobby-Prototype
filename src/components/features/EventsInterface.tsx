...
const EventsInterface = ({ onClose, initialTab = 'events' }: EventsInterfaceProps) => {
    ...
    return (
        <div className="juheng-modal-backdrop fixed inset-0 z-[100] flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="juheng-modal-panel relative flex h-[min(680px,92vh)] w-[94%] max-w-[1100px] flex-col overflow-hidden rounded-[26px] border border-white/10 bg-[#1a0b2e] shadow-2xl animate-in zoom-in-95 duration-200">
