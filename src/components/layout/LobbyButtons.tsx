    ...
    return (
        <>
            ...
            <button
                ...
                className="lobby-promo-button lobby-promo-button--pig absolute bottom-6 left-12 z-[60] flex flex-col items-center cursor-pointer hover:scale-105 active:scale-95 transition-transform origin-bottom-left scale-[1.15]"
            >
            ...
            <button
                ...
                className="lobby-promo-button lobby-promo-button--gift absolute bottom-6 right-12 z-[60] flex flex-col items-center cursor-pointer hover:scale-105 active:scale-95 transition-transform origin-bottom-right scale-[1.15]"
            >
