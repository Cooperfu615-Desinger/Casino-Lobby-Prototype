...
const SettingsMenu = ({ onOpenLanguage, onOpenLegal, onCloseMenu }: SettingsMenuProps) => {
    ...
    return (
        <div className="lobby-settings-menu absolute top-[80px] right-4 z-[100] w-64 bg-[#1a0b2e]/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-top-5 duration-200">
