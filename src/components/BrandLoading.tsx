...
const BrandLoading = ({ onFinished }: BrandLoadingProps) => {
    ...
    return (
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black">
            ...
            {/* Content Container (Fixed 1280x720) */}
            <div className="relative w-[1280px] h-[720px] overflow-hidden shadow-2xl bg-gradient-to-b from-[#2c003e] to-black text-white font-sans flex flex-col items-center justify-center">
