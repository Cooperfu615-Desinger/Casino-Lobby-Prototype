...
import { X, User as UserIcon, Crown, Camera, Copy, ChevronRight, UserCog, Phone, Gem, Headphones, Save, ArrowLeft } from 'lucide-react';
                    ...
                    {activeView === 'overview' ? (
                        ...
                        <div className="animate-in slide-in-from-right duration-300">
                            ...
                            <div className="space-y-6">
                                ...
                                {/* Password */}
                                <div>
                                    <label className="block text-slate-400 text-xs font-bold uppercase mb-2">登入密碼 (Password)</label>
                                    <input
                                        type="password"
                                        value={password}
