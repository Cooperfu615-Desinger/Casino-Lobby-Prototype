...
const EventsInterface = ({ onOpenSale, onOpenTournament }: EventsInterfaceProps) => {
    ...
    return (
        <div className="absolute top-[130px] bottom-[90px] left-0 right-0 z-20 bg-[#120822]/95 border-t border-white/10 animate-in fade-in zoom-in-95 duration-300 overflow-y-auto p-8 custom-scrollbar">
